...
//08.02.2022 YN
#if(Shtray==2) 
    float MassT_st;      // float старший счетчик
    float VolT_st;       // float старший счетчик
    float MassT_ml;      // float младший счетчик
    float VolT_ml;       // float младший счетчик
#endif
