...
char sw_ver[20]="N3.33 20 Oct 2015";  // COM0 COM1 COM2 COM3 COM4
...
float ftmp,ftmp1,ftmp2,ftmp3;
 ...
 if(CL_MassP < 0) CL_MassP=0;
 if(CL_VolP < 0) CL_VolP=0;

 N_resv=ReadNVRAM( nr_resv );
 if(N_resv < 0)  N_resv=0;
 if(N_resv > 10) N_resv=0;
