...
//---------------------------------
      if (!strcmp(intrpr.wrd,"CLM" ))
        {   //'CLM'
         f_dis_set(ds_clm,3,3);
         goto fin;
        }
//---------------------------------
...
//------------------------------------------
      if (!strcmp(intrpr.wrd,"ADT" ))
        {   //'ADT'
          f_dis_set(ds_adt,3,4);
          goto fin;
        }
//------------------------------------------
      if (!strcmp(intrpr.wrd,"ADP" ))
        {   //'ADT'
          f_dis_set(ds_adp,3,9);
          goto fin;
        }
//------------------------------------------
//------------------------------------------
