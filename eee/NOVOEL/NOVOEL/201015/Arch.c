...
*/
 ...
 mm_e:
    ...
    printf(" %04X" ,a_str->u.err.err[1] );    // MVD
    ...
    printf(" %04X" ,a_str->u.err.err[6] );   // Drive
    printf(" %04X:" ,a_str->u.err.err[7] );    //  System
    printf("%04X" ,a_str->u.err.err[8] );    // код
//  printf(" %01X" ,a_str->u.err.err[9] );    // код
