...
void  f_prn_begin()
{
  ...
  MmiGotoxy(0,0); MmiPrintf("ЙНННННННННЛННННННННН»         ");
  MmiGotoxy(0,1); MmiPrintf("єДоза,кг  є Отп.,л  є         ");
  MmiGotoxy(0,2); MmiPrintf("МНННННННННОННННННННН№         ");
  MmiGotoxy(0,3); MmiPrintf("є         є         є         ");
  MmiGotoxy(0,4); MmiPrintf("ЗДДДДДДДДДЧДДДДДДДДД¶         ");
  MmiGotoxy(0,5); MmiPrintf("є         є         є         ");
  MmiGotoxy(0,6); MmiPrintf("є         є         є         ");
  MmiGotoxy(0,7); MmiPrintf("ИНННННННННКНННННННННј         ");
...
main_menu:
  ...
  MmiGotoxy(0,1); MmiPrintf("єДоза,кг  є Отп.,л  є         ");
  MmiGotoxy(0,2); MmiPrintf("МНННННННННОННННННННН№         ");
  MmiGotoxy(0,3); MmiPrintf("є 1234    є         є         ");
  MmiGotoxy(0,4); MmiPrintf("ЗДДДДДДДДДЧДДДДДДДДД¶         ");
  MmiGotoxy(0,5); MmiPrintf("єTest NN  є  LOAD   є         ");
  MmiGotoxy(0,6); MmiPrintf("є         є  731    є         ");
  MmiGotoxy(0,7); MmiPrintf("ИНННННННННКНННННННННј         ");
