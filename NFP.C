...
//16.02.2022 YN
unsigned long int TimeDelayForFirstTurnOn = 0;
int flagFirstTurnOn= 0; 
...
//   f_send_slv();
        ...
        {
          //16.02.2022 YN
          if( f_timer( TimeDelayForFirstTurnOn, 8000L ) )
          {
            f_MVD(0);
            flagFirstTurnOn = 1;
          }
...
//16.02.2022 YN
TimeDelayForFirstTurnOn = TimeStamp;
