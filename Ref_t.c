...
float waTemp = 0.0;
double mas_ch_cur_old = 0.0;
double mas_ch_cur = 0.0;
#endif

//08.02.2022 YN
#if(Shtray==2) //Promass
 double mas_ch1_cur_old=0.0;
float MassT_old=0.0;
double mas_ch1_cur=0.0;
double vol_ch2_cur=0.0;
double mas_ch1_start=0.0;
double vol_ch2_start=0.0;
double mas_ch1_end=0.0;
double vol_ch2_end=0.0;
#endif
